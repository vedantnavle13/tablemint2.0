...
function Navbar({ user, onLogout }) {
  ...
  return (
    <nav style={{ background:C.bgCard, borderBottom:`1px solid ${C.border}`, padding:"0 6%",
      ...
      <div style={{ display:"flex", gap:12, alignItems:"center" }}>
        <button onClick={() => navigate("/explore")}
          style={{ background:"transparent", border:`1.5px solid ${C.border}`, borderRadius:10,
...
function ProfileTab({ user }) {
  ...
  const inp = { width:"100%", padding:"11px 14px", borderRadius:10, border:`1.5px solid ${C.border}`,
    ...
    <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:24, alignItems:"start" }}>
      ...
      <div style={{ background:C.bgCard, borderRadius:16, border:`1px solid ${C.border}`, padding:28 }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:24 }}>
          ...
          {!editing && (
            <button onClick={() => setEditing(true)}
              style={{ padding:"7px 16px", background:C.amberSoft, border:`1px solid ${C.amber}40`,
        ...
        <div style={{ display:"flex", alignItems:"center", gap:16, marginBottom:24 }}>
          <div style={{ width:64, height:64, borderRadius:"50%", background:C.amber+"20",
          ...
          <div>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={saveProfile} disabled={loading}
                style={{ flex:1, padding:"10px", background:C.amber, border:"none", borderRadius:10,
              ...
              <button onClick={() => { setEditing(false); setName(user?.name); setPhone(user?.phone); }}
                style={{ padding:"10px 16px", background:"transparent", border:`1.5px solid ${C.border}`,
    ...
    <div>
      ...
      {filtered.length===0 ? (
        <div style={{ padding:60, textAlign:"center", background:C.bgCard, borderRadius:16, border:`1px solid ${C.border}` }}>
          ...
          <button onClick={() => navigate("/explore")}
            style={{ padding:"12px 28px", background:C.amber, border:"none", borderRadius:12,
              color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"'DM Sans',sans-serif" }}>
            Browse Restaurants →
          </button>
        </div>
        ...
        <div style={{ display:"flex", gap:20 }}>
            ...
            {filtered.map(r => {
              ...
              return (
                <div key={r._id} onClick={() => setSelected(isSelected ? null : r)}
                  style={{ background:C.bgCard, borderRadius:14, border:`1.5px solid ${isSelected?C.amber:C.border}`,
                    ...
                    <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:8 }}>
                      ...
                      {upcoming && (
                        <button
                          ...
                          style={{ padding:"5px 12px", background:C.red+"15", border:`1px solid ${C.red}30`,
          ...
          {/* Detail panel */}
          {selected && (
            <div style={{ width:300, flexShrink:0, background:C.bgCard, borderRadius:16,
              ...
              {canCancel(selected) && (
                <button
                  ...
                  style={{ width:"100%", marginTop:16, padding:"11px", background:C.red+"15",
  ...
  if (loading) return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:C.bg }}>
      <div style={{ textAlign:"center" }}>
        <div style={{ width:40, height:40, border:`4px solid ${C.border}`, borderTop:`4px solid ${C.amber}`,
    ...
    <div style={{ minHeight:"100vh", background:C.bg, fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{ maxWidth:1100, margin:"0 auto", padding:"40px 24px" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:20, marginBottom:36,
          ...
          <div style={{ width:72, height:72, borderRadius:"50%", background:C.amber+"20",
            display:"flex", alignItems:"center", justifyContent:"center",
          ...
          <button onClick={() => navigate("/explore")}
            style={{ padding:"11px 24px", background:C.amber, border:"none", borderRadius:12,
              color:"#fff", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"'DM Sans',sans-serif",
        ...
        <div style={{ display:"flex", gap:4, marginBottom:28, borderBottom:`1px solid ${C.border}` }}>
          {[
            ...
            <button key={t.id} onClick={() => setTab(t.id)}
              style={{ padding:"12px 24px", background:"transparent", border:"none",
